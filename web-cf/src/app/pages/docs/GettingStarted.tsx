  ...
  return (
    <article className="prose prose-neutral max-w-none">
      ...
      <p>
        ...
        <Link to="/#download">home page</Link>. Open it and enter your{' '}
      ...
      <p>
        ...
        <Link to="/docs/security">Security</Link> for details on how this works.
      </p>
      ...
      <div className="not-prose mt-12 flex flex-wrap gap-3">
        <Link to="/docs/what-is-a-site" className="btn btn-ghost btn-sm">
          &larr; What is a Site?
        </Link>
        <Link to="/docs/security" className="btn btn-primary btn-sm">
          Security &rarr;
        </Link>
        <Link to="/docs/publishing" className="btn btn-ghost btn-sm">
          Publishing Sites &rarr;
        </Link>
      </div>
    </article>
  );
