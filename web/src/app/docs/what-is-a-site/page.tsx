export default function WhatIsAnExtension() {
  return (
    <article className="prose prose-neutral max-w-none">
      ...
      <div className="not-prose mt-12 flex flex-wrap gap-3">
        <a href="/docs/getting-started" className="btn btn-primary btn-sm">
          Build your first Site
        </a>
        <a href="/docs/security" className="btn btn-outline btn-sm">
          Security model
        </a>
        <a href="/docs/publishing" className="btn btn-outline btn-sm">
          Publishing a Site
        </a>
      </div>
    </article>
